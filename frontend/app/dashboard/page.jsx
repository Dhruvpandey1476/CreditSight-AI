        ...
        <div className="w-full lg:w-[380px] shrink-0 bg-surface border border-border rounded-2xl shadow-sm h-full flex flex-col overflow-hidden">
          ...
          <div className="flex flex-col gap-2 mb-8">
            {demoProfiles.map((dp, i) => (
              <div
                key={i}
                className={`p-3 rounded-lg border cursor-pointer transition-all hover:shadow-sm hover:-translate-y-[1px] ${
                  activeDemo === i
        ...
        <nav className="flex-1 px-3 py-4 flex flex-col gap-1 overflow-x-hidden overflow-y-auto custom-scrollbar">
          {[
            ...
            <button
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all whitespace-nowrap overflow-hidden hover:scale-[1.02] active:scale-95 ${
                activeNav === item.id 
